...
include_once("config.php");
    ...
    $consulta = 'SELECT * FROM datos_personas, contratos, usuarios WHERE contratos.rela_persona= datos_personas.id_persona AND datos_personas.rela_usuario= usuarios.Cod_usuario AND usuarios.Cod_usuario= 14';
   ...
   <?php 
     if (empty($contenido)) {
             echo "<script language='JavaScript'>
                alert('Ud no tiene contratos por el momento...'); 
              </script>";
        } 
    ?>
    <!-- jQuery -->
