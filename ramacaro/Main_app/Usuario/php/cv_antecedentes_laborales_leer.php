<?php
  ...
  try {
    ...
    while ($fila = $sentencia->fetch(PDO::FETCH_ASSOC, PDO::FETCH_ORI_NEXT)) {
      ...
      echo "<td><a href= \"cv_antecedentes_laborales_modificar.php?id_ant_lab=$fila[id_ant_lab]\">Modificar</a></td>";
      echo "<td><a href=\"cv_antecedentes_laborales_borrar.php?id_ant_lab=$fila[id_ant_lab]\" onClick=\"return confirm('Estas seguro de querer borrar?')\" >Borrar</a></td>"; 
    }
    $sentencia = null;
  }
