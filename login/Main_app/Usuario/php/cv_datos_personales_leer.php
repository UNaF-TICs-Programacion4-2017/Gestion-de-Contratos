<?php session_start(); 
    ...
    $result = $dbConn->query('SELECT * FROM datos_personas, usuarios WHERE rela_user = \''.$idusuario.'\'');
?>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <a href="../html/cv_datos_personales.html" id="btnagregar" class="btn btn-primary btn-sm">Agregar</a>
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
