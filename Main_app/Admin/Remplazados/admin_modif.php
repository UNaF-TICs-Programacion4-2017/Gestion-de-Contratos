...
{   
    ...
    $email = $_POST['email'];
        ...
        //updating the table
        $sql = "UPDATE usuarios SET NombreUsuario=:nombreusuario, Usuario=:usuario, Password=:pass, email=:email  WHERE Cod_usuario=:Cod_usuario";
        $query = $dbConn->prepare($sql);
                
        $query->bindparam(':Cod_usuario', $Cod_usuario);
...
//getting id from url
    ...
    $sql = "SELECT NombreUsuario, Usuario, Password, email FROM usuarios WHERE Cod_usuario=:Cod_usuario";
    $query = $dbConn->prepare($sql);
    $query->execute(array(':Cod_usuario' => $Cod_usuario));
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Haga los cambios que se requieren y luego haga click en aceptar
                        </div>
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="admin_modif.php" method="post" name="form1"> 
                                        <div class="form-group">
                                            <label>Nombre de Usuario</label>
                                            <input type="text" name="nombre" class="form-control" value="<?php echo $nombreusuario;?>">              
                                        </div>
                                        <div class="form-group">
                                            <label>ALIAS</label>
                                            <input type="text" name="alias" class="form-control" value="<?php echo $usuario;?>">
                                        </div>
                                        <div class="form-group">
