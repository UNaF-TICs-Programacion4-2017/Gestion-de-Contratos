...
if(isset($_POST['Submit'])) {	
	...
	$rela_usuario = $_SESSION['id'];
		...
		$sql = "INSERT INTO antecedentes_docentes(desde, hasta, universidad, cargo, catedra, carrera, facultad, rela_usuario) VALUES(:desde, :hasta, :universidad, :cargo, :catedra, :carrera, :facultad, :rela_usuario)";
