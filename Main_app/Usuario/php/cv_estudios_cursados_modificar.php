...
//echo $_POST['id_titulo'];
if(isset($_POST['update_ec'])) {	
    ...
    $titulo_obtenido = $_POST['titulo_obtenido'];
 		...
 		//updating the table
		$sql = "UPDATE titulos_obtenidos SET tipo_titulo=:tipo_titulo, desde=:desde, hasta=:hasta, universidad=:universidad, titulo=:titulo_obtenido WHERE id_titulo=:id_titulo";
...
<?php
    ...
    $sql = "SELECT tipo_titulo, desde, hasta, universidad, titulo FROM titulos_obtenidos WHERE id_titulo=:id_titulo";
